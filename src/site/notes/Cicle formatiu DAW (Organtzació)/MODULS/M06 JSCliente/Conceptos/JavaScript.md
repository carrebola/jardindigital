---
{"dg-publish":true,"permalink":"/cicle-formatiu-daw-organtzacio/moduls/m06-js-cliente/conceptos/java-script/"}
---
...
3. **Versatilidad**: Aunque originalmente se diseñó para el desarrollo web del lado del cliente, hoy en día JavaScript también se usa en el servidor (gracias a entornos como [[Cicle formatiu DAW (Organtzació)/MODULS/M06 JSCliente/Conceptos/Node.js\|Node.js]]), aplicaciones móviles, aplicaciones de escritorio y más.
...
5. **Bibliotecas y Frameworks**: Existen numerosas bibliotecas (como jQuery) y frameworks (como [[Cicle formatiu DAW (Organtzació)/MODULS/M06 JSCliente/Conceptos/Angular\|Angular]], [[Cicle formatiu DAW (Organtzació)/MODULS/M06 JSCliente/Conceptos/React\|React]] y [[Vue.js\|Vue.js]]) que facilitan el desarrollo y amplían las capacidades de JavaScript.
